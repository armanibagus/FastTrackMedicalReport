        ...
        <div class="row">
                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="#!" class="btn btn-sm btn-outline-success">See all</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form role="form" action="../../action/action-record-tester.php" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="position" class="form-control" placeholder="Enter position" value="Tester" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
