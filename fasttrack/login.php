...
<head>
    ...
    <title>FastTrack Medical Report</title>
    <!-- Favicon -->
...
<body class="bg-gradient-success">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header py-6" style="padding-top: 4rem; padding-bottom: 4rem">
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Welcome!</h1>
              <p class="text-lead text-white">Keep healthy, keep strong, and use your mask!</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Footer -->
  <footer class="footer pt-5 bg-gradient-success">
