      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            ...
            $data = mysqli_query($connect, "select * from patient where patient_id = '$patient_id'");
            while($d = mysqli_fetch_array($data)){
            ?>
              <form role="form" action="../action/action-update-patient.php" method="post" onSubmit="return validation()">
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-circle-08"></i></span>
                    </div>
                      <input class="form-control" placeholder="Patient ID" type="hidden" name="patient_id" id="patient_id" value="<?php echo $d['patient_id']?>">
                      <input class="form-control" placeholder="Username" type="hidden" name="username" id="username" value="<?php echo $d['username']?>">
                    <input class="form-control" placeholder="Username" type="text" value="<?php echo $d['username']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Password" type="hidden" name="password" id="password" value="<?php echo $d['password']?>" >
                    <input class="form-control" placeholder="Password" type="password" value="<?php echo $d['password']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Name" type="hidden" name="patient_name" id="patient_name" value="<?php echo $d['name']?>">
                      <input class="form-control" placeholder="Name" type="text" value="<?php echo $d['name']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Phone Number" type="hidden" name="phone_number" id="phone_number">
                      <input class="form-control" placeholder="Phone Number" type="text" value="<?php echo $d['phone_number']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Address" type="hidden" name="address" id="address">
                      <input class="form-control" placeholder="Address" type="text" value="<?php echo $d['address']?>" disabled>
                    </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
...
<script type="text/javascript">
    function validation() {
        ...
        if (patient_type!="" && symptoms!="" && test_kit!="" ) {
            return true;
        }else{
            alert('Empty field!');
            return false;
