...
<head>
  ...
  <title>Covid-19 Test Form</title>
  <!-- Favicon -->
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon d-lg-none d-block" href="update-test-result.php">
                <i class="fa fa-arrow-left text-green "></i>
                <span class="nav-link-inner--text text-green">Back</span>
              </a>
            </li>
          <li class="nav-item d-none d-lg-block ml-lg-4">
            <a href="update-test-result.php" class="btn btn-outline-success btn-icon">
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            <div class="card-header pb-2">
              <div class="text-muted text-center mt-2 mb-4"><h2 class="text-green">Test Details</h2></div>
            </div>
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Test ID" type="hidden" name="test_id" id="test_id" value="<?php echo $d['test_id']?>" >
                      <input class="form-control" placeholder="Test ID" type="text" value="<?php echo $d['test_id']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    <div class="input-group-prepend">
                      ...
                      <input class="form-control" placeholder="Test Date" type="hidden" name="test_date" id="test_date" value="<?php echo $d['test_date']?>">
                    <input class="form-control" placeholder="Test Date" type="text" value="<?php echo $d['test_date']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
