        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    <br><br>
                    <h1 class="display-2 text-white">Hello Center Officer</h1>
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-center">
                            <h5 class="h3">0
                                Armani Bagus<span class="font-weight-light">, Manager</span>
                            </h5>
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>Bali, Indonesia
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>Student at
                            </div>
                            <div>
